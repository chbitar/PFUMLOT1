      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>{absenceEntity.etudiantsLicence ? absenceEntity.etudiantsLicence.nom +' '+ absenceEntity.etudiantsLicence.prenom: ''}</dd>
            <dt>
            ...
            <dd>{absenceEntity.etudiantsExecutif ? absenceEntity.etudiantsExecutif.nom +' '+ absenceEntity.etudiantsExecutif.prenom:''}</dd>
          </dl>
