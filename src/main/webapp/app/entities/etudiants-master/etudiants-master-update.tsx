...
export class EtudiantsMasterUpdate extends React.Component<IEtudiantsMasterUpdateProps, IEtudiantsMasterUpdateState> {
  ...
  render() {
    ...
    const {
      releveeNoteBac,
      releveeNoteBacContentType,
      photo,
      photoContentType,
      tesAdmission,
      tesAdmissionContentType,
      bacalaureat,
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : etudiantsMasterEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="anneeObtentionBacLabel" for="etudiants-master-anneeObtentionBac">
                    <Translate contentKey="pfumv10App.etudiantsMaster.anneeObtentionBac">Annee Obtention Bac</Translate>
                  </Label>
                  <AvField id="etudiants-master-anneeObtentionBac" type="text" name="anneeObtentionBac" />
                </AvGroup>
                <AvGroup>
                  <AvGroup>
                    <Label id="releveeNoteBacLabel" for="releveeNoteBac">
                      <Translate contentKey="pfumv10App.etudiantsMaster.releveeNoteBac">Relevee Note Bac</Translate>
                    </Label>
                    <br />
                    {releveeNoteBac ? (
                      <div>
                        <a onClick={openFile(releveeNoteBacContentType, releveeNoteBac)}>
                          <img src={`data:${releveeNoteBacContentType};base64,${releveeNoteBac}`} style={{ maxHeight: '100px' }} />
                        </a>
                        <br />
                        <Row>
                          <Col md="11">
                            <span>
                              {releveeNoteBacContentType}, {byteSize(releveeNoteBac)}
                            </span>
                          </Col>
                          <Col md="1">
                            <Button color="danger" onClick={this.clearBlob('releveeNoteBac')}>
                    ...
                    <input id="file_releveeNoteBac" type="file" onChange={this.onBlobChange(true, 'releveeNoteBac')} accept="image/*" />
                    <AvInput type="hidden" name="releveeNoteBac" value={releveeNoteBac} />
                  </AvGroup>
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <AvGroup>
                    <Label id="tesAdmissionLabel" for="tesAdmission">
                      <Translate contentKey="pfumv10App.etudiantsMaster.tesAdmission">Tes Admission</Translate>
                    </Label>
                    <br />
                    {tesAdmission ? (
                      <div>
                        <a onClick={openFile(tesAdmissionContentType, tesAdmission)}>
                          <img src={`data:${tesAdmissionContentType};base64,${tesAdmission}`} style={{ maxHeight: '100px' }} />
                        </a>
                        <br />
                        <Row>
                          <Col md="11">
                            <span>
                              {tesAdmissionContentType}, {byteSize(tesAdmission)}
                            </span>
                          </Col>
                          <Col md="1">
                            <Button color="danger" onClick={this.clearBlob('tesAdmission')}>
                              <FontAwesomeIcon icon="times-circle" />
                            </Button>
                          </Col>
                        </Row>
                    ...
                    <input id="file_tesAdmission" type="file" onChange={this.onBlobChange(true, 'tesAdmission')} accept="image/*" />
                    <AvInput type="hidden" name="tesAdmission" value={tesAdmission} />
                  </AvGroup>
                </AvGroup>
                <AvGroup>
                  <AvGroup>
                ...
                <AvGroup>
                  <AvGroup>
                    <Label id="releveeNoteLicenceLabel" for="releveeNoteLicence">
                      <Translate contentKey="pfumv10App.etudiantsMaster.releveeNoteLicence">Relevee Note Licence</Translate>
                    </Label>
                    <br />
                    {releveeNoteLicence ? (
                      <div>
                        <a onClick={openFile(releveeNoteLicenceContentType, releveeNoteLicence)}>
                          <img src={`data:${releveeNoteLicenceContentType};base64,${releveeNoteLicence}`} style={{ maxHeight: '100px' }} />
                        </a>
                        <br />
                        <Row>
                          <Col md="11">
                            <span>
                              {releveeNoteLicenceContentType}, {byteSize(releveeNoteLicence)}
                            </span>
                          </Col>
                          <Col md="1">
                            <Button color="danger" onClick={this.clearBlob('releveeNoteLicence')}>
                              <FontAwesomeIcon icon="times-circle" />
                            </Button>
                          </Col>
                        </Row>
                    ...
                    <input
                      id="file_releveeNoteLicence"
                      type="file"
                      onChange={this.onBlobChange(true, 'releveeNoteLicence')}
                      accept="image/*"
                    />
                    <AvInput type="hidden" name="releveeNoteLicence" value={releveeNoteLicence} />
                  </AvGroup>
                </AvGroup>
                <AvGroup>
                  <Label id="etablissementObtentionLabel" for="etudiants-master-etablissementObtention">
                    <Translate contentKey="pfumv10App.etudiantsMaster.etablissementObtention">Etablissement Obtention</Translate>
                  </Label>
                  <AvField id="etudiants-master-etablissementObtention" type="text" name="etablissementObtention" />
                </AvGroup>
                <AvGroup>
