            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : etudiantsLicenceEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="etudiants-licence-suffixe" type="text" name="suffixe" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label id="anneeObtentionLabel" for="etudiants-licence-anneeObtention">
                    <Translate contentKey="pfumv10App.etudiantsLicence.anneeObtention">Annee Obtention</Translate>
                  </Label>
                  <AvField id="etudiants-licence-anneeObtention" type="text" name="anneeObtention" />
                </AvGroup>
                <AvGroup>
                  <AvGroup>
                    <Label id="releveeNoteLabel" for="releveeNote">
                      <Translate contentKey="pfumv10App.etudiantsLicence.releveeNote">Relevee Note</Translate>
                    </Label>
                    <br />
                    {releveeNote ? (
                      <div>
                ...
                <AvGroup>
                  <AvGroup>
                    <Label id="testAdmissionLabel" for="testAdmission">
                      <Translate contentKey="pfumv10App.etudiantsLicence.testAdmission">Test Admission</Translate>
                    </Label>
                    <br />
                    {testAdmission ? (
                      <div>
