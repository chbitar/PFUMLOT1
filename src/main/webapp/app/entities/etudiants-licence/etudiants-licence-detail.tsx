      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              {etudiantsLicenceEntity.releveeNote ? (
                <div>
                  <a onClick={openFile(etudiantsLicenceEntity.releveeNoteContentType, etudiantsLicenceEntity.releveeNote)}>
                    <img
                      src={`data:${etudiantsLicenceEntity.releveeNoteContentType};base64,${etudiantsLicenceEntity.releveeNote}`}
                      style={{ maxHeight: '30px' }}
                    />
                  </a>
                  <span>
                    {etudiantsLicenceEntity.releveeNoteContentType}, {byteSize(etudiantsLicenceEntity.releveeNote)}
                  </span>
                </div>
              ) : null}
            </dd>
