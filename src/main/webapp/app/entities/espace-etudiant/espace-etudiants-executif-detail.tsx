...
import { getEntity, envoyerMail, getEntityDetail } from '../etudiants-executif/etudiants-executif.reducer';
...
export interface IEspaceEtudiantsExecutifProps extends StateProps, DispatchProps, RouteComponentProps<{ bloc: string }> {}

export class EspaceEtudiantsExecutif extends React.Component<IEspaceEtudiantsExecutifProps> {
  componentDidMount() {
    this.props.getEntityDetail();
    this.props.getDocuments('MASTER_EXECUTIF');
    this.props.getCalendrierExamens('MASTER_EXECUTIF');
  }
  ...
  render() {
    const { etudiantsExecutifEntity, documentList, calendrierExamens } = this.props;
    return (
      <div>
        <div>
          <br />
          ...
          <Row>
            <Col md="6">
              <div style={{ float: 'right', display: 'inline-block' }}>
                <Button tag={Link} to="/entity/espace-etudiant/executif/profil" replace color="info">
...
const mapStateToProps = ({ etudiantsExecutif, authentication, document, calendrierModule }: IRootState) => ({
