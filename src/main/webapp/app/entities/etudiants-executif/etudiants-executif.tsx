              ...
              <tbody>
                {etudiantsExecutifList.map((etudiantsExecutif, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{etudiantsExecutif.anneeObtention}</td>
                    ...
                    <td>
                      {etudiantsExecutif.cv ? (
                        <div>
                          <a onClick={openFile(etudiantsExecutif.cvContentType, etudiantsExecutif.cv)}>
                            <img
                              src={`data:${etudiantsExecutif.cvContentType};base64,${etudiantsExecutif.cv}`}
                              style={{ maxHeight: '30px' }}
                            />
                            &nbsp;
                          </a>
                          <span>
                            {etudiantsExecutif.cvContentType}, {byteSize(etudiantsExecutif.cv)}
                          </span>
                        </div>
                      ) : null}
                    </td>
                    <td>
                      {etudiantsExecutif.attestationTravail ? (
                        <div>
                          <a onClick={openFile(etudiantsExecutif.attestationTravailContentType, etudiantsExecutif.attestationTravail)}>
                            <img
                              src={`data:${etudiantsExecutif.attestationTravailContentType};base64,${etudiantsExecutif.attestationTravail}`}
                              style={{ maxHeight: '30px' }}
                            />
                            &nbsp;
                          </a>
                          <span>
                            {etudiantsExecutif.attestationTravailContentType}, {byteSize(etudiantsExecutif.attestationTravail)}
                          </span>
                        </div>
                      ) : null}
                    </td>
                    ...
                    <td>
                      {etudiantsExecutif.testAdmission ? (
                        <div>
                          <a onClick={openFile(etudiantsExecutif.testAdmissionContentType, etudiantsExecutif.testAdmission)}>
                            <img
                              src={`data:${etudiantsExecutif.testAdmissionContentType};base64,${etudiantsExecutif.testAdmission}`}
                              style={{ maxHeight: '30px' }}
                            />
                            &nbsp;
                          </a>
                          <span>
                            {etudiantsExecutif.testAdmissionContentType}, {byteSize(etudiantsExecutif.testAdmission)}
                          </span>
                        </div>
                      ) : null}
                    </td>
                    <td>
                      {etudiantsExecutif.releveeNote ? (
                        <div>
                          <a onClick={openFile(etudiantsExecutif.releveeNoteContentType, etudiantsExecutif.releveeNote)}>
                            <img
                              src={`data:${etudiantsExecutif.releveeNoteContentType};base64,${etudiantsExecutif.releveeNote}`}
                              style={{ maxHeight: '30px' }}
                            />
                            &nbsp;
                          </a>
                          <span>
                            {etudiantsExecutif.releveeNoteContentType}, {byteSize(etudiantsExecutif.releveeNote)}
                          </span>
                        </div>
                      ) : null}
                    </td>
