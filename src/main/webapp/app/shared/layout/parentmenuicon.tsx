...
export interface IParentMenuIconProps {
  text: string;
}

export interface IParentMenuIconProps extends StateProps, DispatchProps {}

export class ParentMenuIcon extends React.Component<IParentMenuIconProps> {
  componentDidMount() {
